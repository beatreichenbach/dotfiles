...
hl.window_rule({
    name = "popout",
    match = {
        class = "discord|org.mozilla.firefox",
        title = "Discord Popout|Picture-in-Picture",
    },
    float = true,
    pin = true,
})
...
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(fileManager))
hl.bind(mainMod .. " + V", hl.dsp.window.float({ action = "toggle" }))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd(menu .. " launcher toggle"))
hl.bind(mainMod .. " + P", hl.dsp.window.pseudo())
...
-- Source: /home/beat/.config/hypr/noctalia/noctalia-colors.conf — convert this file to Lua and ensure it is on Lua's package.path.
...
hl.config({
    general = {
        ...
        col = {
            active_border = { colors = { "rgba(98c379ee)", "rgba(62baC6ee)" }, angle = 135 },
            inactive_border = "rgba(595959aa)",
        },
